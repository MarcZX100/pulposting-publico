...
module.exports = {
  ...
  name: "kiss", //Nombre de comando
  cooldown: 5, //Tiempo para volver a usar el comando (en segundos)
  aliases: [], //Aliases para usarlo
  description: "Lots of kisses for the best person on the server!", //Descripción del comando
  ...
  exec: async (client, message, args) => {
    ...
    let url = await soyultro("kiss");
    let user = message.mentions.users.first()
      ? `kisses ${message.mentions.users.first().tag} <3`
      : `come here, I will kiss you :3`;
